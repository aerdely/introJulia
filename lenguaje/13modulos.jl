...
Podemos averiguar a qué módulo pertenecen ciertos objetos
...
De hecho podríamos averiguar primero si existe una etiqueta asociada a un
objeto en el módulo actual `Main`
=#
...
module-submodule path, por ejemplo:
=#
